  ...
  return (
    <main className="px-6 lg:px-12 py-12 max-w-7xl mx-auto animate-fade-up">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8">
        ...
        <Link href="/write" className="inline-flex items-center gap-2 px-6 py-2.5 bg-black text-white font-sans text-sm font-medium rounded-md hover:bg-gray-800 transition-colors self-start">
          <PenLine size={16} />
          New post
        </Link>
      </div>
