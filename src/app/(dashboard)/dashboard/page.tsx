  ...
  return (
    <main className="px-8 py-10 max-w-5xl mx-auto animate-fade-up bg-gradient-to-b from-[var(--bg-primary)] to-[var(--bg-secondary)] min-h-screen">
      ...
      <section className="mb-10">
        {focusDraft ? (
          <div className="rounded-3xl border border-[var(--border-light)] bg-[var(--bg-primary)]/80 backdrop-blur p-8 shadow-lg">
          ...
          <div className="rounded-3xl border border-dashed border-[var(--border-light)] bg-[var(--bg-primary)]/70 backdrop-blur p-8 shadow">
            <p className="text-xs uppercase tracking-[0.15em] text-[var(--text-tertiary)] mb-3">
              Ready to create?
            </p>
            <h2 className="font-display text-2xl font-semibold text-[var(--text-primary)] mb-2">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <Link
              href="/write"
              className="flex items-center gap-4 p-4 rounded-2xl border border-[var(--border-light)] bg-[var(--bg-primary)]/90 shadow hover:border-[var(--accent)] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--accent)]"
            >
          ...
          {hasPublished && statsVisible && (
            <div className="mt-6 p-5 rounded-2xl border border-[var(--border-light)] bg-[var(--bg-primary)]/80 shadow">
        ...
        <div className="space-y-4">
          ...
          {recentCaptures.length > 0 ? (
            <div className="space-y-3">
              {recentCaptures.map((capture, i) => (
                <Link
                  ...
                  className={`block p-4 rounded-2xl border border-[var(--border-light)] bg-[var(--bg-primary)]/90 shadow hover:border-[var(--accent)] transition-colors ${i % 2 === 1 ? 'bg-[var(--bg-secondary)]/40' : ''}`}
                >
            ...
            <div className="p-5 rounded-2xl border border-dashed border-[var(--border-light)] bg-[var(--bg-primary)]/70 text-center">
