...
const PAGES = [
  ...
  ['clear',      'src/app/(app)/clear/page.tsx',        21],
  ['triage',     'src/app/(app)/triage/page.tsx',       16],
  ['export',     'src/app/(app)/export/page.tsx',       15],
  ['dossier',    'src/app/(app)/facts/page.tsx',        25],
  ['source',     'src/app/(app)/glossary/page.tsx',     13],
  ['asks',       'src/app/(app)/asks/page.tsx',         13],
  ['numbers',    'src/app/(app)/numbers/page.tsx',       9],
